...
function vw_school_education_sanitize_email( $email, $setting ) {
...
if ( ! function_exists( 'vw_school_education_credit' ) ) {
	function vw_school_education_credit(){
		echo "<a href=".esc_url(VW_SCHOOL_EDUCATION_CREDIT).">".esc_html__('School WordPress Theme','vw-school-education')."</a>";
	}
}
