...
<article id="post-<?php the_ID(); ?>" <?php post_class('inner-service'); ?>>
  <div class="service-box">
    ...
    <?php }else if($vw_school_education_theme_lay == 'Center'){ ?>
      <div class="new-text">
        <h2 class="section-title"><a href="<?php echo esc_url( get_permalink() ); ?>" title="<?php echo the_title_attribute(); ?>"><?php the_title();?><span class="screen-reader-text"><?php the_title(); ?></span></a></h2>  
        <?php if( get_theme_mod( 'vw_school_education_toggle_postdate',true) != '' || get_theme_mod( 'vw_school_education_toggle_author',true) != '' || get_theme_mod( 'vw_school_education_toggle_comments',true) != '') { ?> 
          <div class="metabox">
